...
<div class="box">
  <div class="box-header bg-primary">
    <h3 class="box-title" style="color: white; font-weight: bold">Hotel List ( <?php echo mysqli_num_rows($query); ?> Hotel )</h3>
  </div><!-- /.box-header -->
  <div class="box-body">
    <?php if (isset($_SESSION['username'])): ?>
  	  <a href="admin.php?page=hotel_add" style="margin-bottom: 10px;" class="btn btn-md btn-success"><i class="fa fa-plus">&nbsp;&nbsp;</i>Add New Hotel</a>
		<?php endif; ?>
